...
import (
	...
	"github.com/subrahamanyam341/andes-core-go/core/mock"
	"github.com/subrahamanyam341/andes-core-go/core/pubkeyConverter"
)
...
func TestBech32PubkeyConverter_EncodeSliceShouldWork(t *testing.T) {
	...
	assert.Equal(t, []string{"moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8", "moa1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruq0yu4wk"}, str)
}
