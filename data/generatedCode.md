...
```
//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/subrahamanyam341/protobuf/protobuf  --gogoslick_out=. message.proto
```
...
Check [gogo protobuf geting started](https://github.com/subrahamanyam341/protobuf#getting-started) for initial setup.
