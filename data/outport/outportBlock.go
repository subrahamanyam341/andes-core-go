//go:generate protoc -I=. -I=$GOPATH/src/github.com/subrahamanyam341/andes-core-go/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/subrahamanyam341/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
