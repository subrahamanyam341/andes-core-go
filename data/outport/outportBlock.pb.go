...
import (
	...
	alteredAccount "github.com/subrahamanyam341/andes-core-go/data/alteredAccount"
	block "github.com/subrahamanyam341/andes-core-go/data/block"
	receipt "github.com/subrahamanyam341/andes-core-go/data/receipt"
	rewardTx "github.com/subrahamanyam341/andes-core-go/data/rewardTx"
	smartContractResult "github.com/subrahamanyam341/andes-core-go/data/smartContractResult"
	transaction "github.com/subrahamanyam341/andes-core-go/data/transaction"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type FeeInfo struct {
	...
	Fee            *math_big.Int `protobuf:"bytes,2,opt,name=Fee,proto3,casttypewith=math/big.Int;github.com/subrahamanyam341/andes-core-go/data.BigIntCaster" json:"fee,omitempty"`
	InitialPaidFee *math_big.Int `protobuf:"bytes,3,opt,name=InitialPaidFee,proto3,casttypewith=math/big.Int;github.com/subrahamanyam341/andes-core-go/data.BigIntCaster" json:"initialPaidFee,omitempty"`
}
...
var fileDescriptor_661b95cef868af95 = []byte{
	...
	0xc9, 0x2e, 0x16, 0x21, 0x63, 0xf2, 0x23, 0x14, 0x65, 0x85, 0xd8, 0xb4, 0xf3, 0x67, 0xe2, 0x24,
	0x56, 0xdb, 0xb0, 0x04, 0x2d, 0x82, 0x9a, 0xe9, 0x72, 0x4f, 0x2b, 0x33, 0x5d, 0x43, 0x57, 0x8f,
	0xf1, 0x70, 0x81, 0x13, 0xcb, 0x01, 0xa4, 0x3d, 0x72, 0xe3, 0x8a, 0x38, 0x23, 0x71, 0xe0, 0x8e,
	0x38, 0xa1, 0x9c, 0x50, 0x4e, 0x0d, 0x71, 0x2e, 0xa8, 0x0f, 0x68, 0x6f, 0x5c, 0x51, 0x57, 0x55,
	0x4f, 0x57, 0xf7, 0xb4, 0x57, 0x63, 0x96, 0x68, 0x2f, 0xf6, 0xf4, 0xfb, 0xf9, 0x5e, 0xd5, 0xfb,
	...
	,
}
