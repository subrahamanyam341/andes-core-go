//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/subrahamanyam341/protobuf/protobuf  --gogoslick_out=. scheduled.proto
package scheduled

import (
	"github.com/subrahamanyam341/andes-core-go/data"
	"github.com/subrahamanyam341/andes-core-go/data/block"
	"github.com/subrahamanyam341/andes-core-go/data/smartContractResult"
	"github.com/subrahamanyam341/andes-core-go/data/transaction"
)
